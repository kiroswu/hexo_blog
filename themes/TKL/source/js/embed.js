	...
	if (o.extend = function (e, t) {
		...
		for (var a, i, r, n = " " + e + "=", o = t.cookie.split(";"), d = 0; d < o.length; d++)
			...
			for (var l in Object.prototype)
				return alert("Object.prototype 不为空，请不要给 Object.prototype Settings方法");
			var c,
			u,
			p = e.JSON,
			h = e.location,
			...
			q = function () {
				if (!c && (c = e.duoshuoQuery)) {
					if (!c.short_name || "your_duoshuo_short_name" === c.short_name)
						return c = s, void alert("You have not set your domain");
			...
			S = e.DUOSHUO = {
				...
				elapsedTime : function (e) {
					...
					s = new Date,
					a = (s - b - t) / 1e3;
					return 10 > a ? "A moment ago" : 60 > a ? Math.round(a) + "seconds ago" : 3600 > a ? Math.round(a / 60) + "minutes ago" : 86400 > a ? Math.round(a / 3600) + "Hours ago" : (s.getFullYear() == t.getFullYear() ? "" : t.getFullYear() + "/") + (t.getMonth() + 1) + "/" + t.getDate() + ""
				},
						...
						n.onmessage = function (e) {
							...
							case "post":
								for (var a, r = 0; r < S.pagelets.length; r++)
									a = S.pagelets[r], a.threadId == t.thread_id && a.onMessage(t);
								break;
							case "notification":
								y.push(t),
								i()
			...
			z = {
				...
				hottest : "Hottest",
				share_to : "Share to:",
				leave_a_message : "Say something…",
				no_comments_yet : "No comment, waiting for you to rob sofa",
				repost_reason : "Forward reason",
				hot_posts_title : "Up Comment",
				comments_zero : "No Comments",
				comments_one : "1 Comment",
				comments_multiple : "{num} Comments",
				reposts_zero : "No Forward",
				reposts_one : "1 Forward",
				reposts_multiple : "{num} Forwards",
				weibo_reposts_zero : "No Weibo",
				weibo_reposts_one : "1 Weibo",
				weibo_reposts_multiple : "{num} Weibo",
				qqt_reposts_zero : "No Tencnt Weibo",
				qqt_reposts_one : "1Tencnt Weibo",
				qqt_reposts_multiple : "{num}Tencnt Weibos"
			},
			D = {
				get : function (e) {
					return m ? m[e] : void 0
			...
			et.commentList = function (e) {
				...
				if (s)
					for (var a, i = -1, r = s.length - 1; r > i; )
						a = s[i += 1], t += '<li class="ds-comment', e.options.show_avatars && (t += " ds-show-avatars"), t += '" data-post-id="' + a.post_id + '">', e.options.show_avatars && (t += '<div class="ds-avatar">' + et.avatar(a.theAuthor, e.options.avatar_size) + "</div>"), t += '<div class="ds-meta">' + et.userAnchor(a.theAuthor), e.options.show_time && (t += et.timeText(a.created_at)), t += "</div>", t += e.options.show_title ? '<div class="ds-thread-title">在 <a href="' + u(a.thread.url) + '#comments">' + u(a.thread.title) + '</a> 中Comment</div><div class="ds-excerpt">' + a.message + "</div>" : '<a class="ds-excerpt" title="' + a.thread.title + ' 中的Comment" href="' + u(a.thread.url) + '#comments">' + a.message + "</a>", t += "</li>";
				return t
			},
			...
			et["dialog-qrcode"] = function (e) {
				var t = '<h2>微信扫一扫，Share to朋友圈</h2><div class="ds-share-qrcode" style="text-align:center;"><img src="' + e.qrcode_url + '" alt="' + e.url + '"></div>';
				return t
			},
			et["dialog-reposts"] = function (e) {
				var t = '<h2>Forward到微博</h2><div class="ds-quote"><strong>@' + u(e.post.theAuthor.name) + "</strong>: " + e.post.message + "</div><form>" + tt({
			...
			et.dialog = function (e) {
				var t = '<div class="ds-dialog"><div class="ds-dialog-inner ds-rounded"><div class="ds-dialog-body">' + e + '</div><div class="ds-dialog-footer"><a href="http://duoshuo.com/" target="_blank" class="ds-logo"></a><span>社会化Comment框</span></div><a class="ds-dialog-close" href="javascript:void(0)" title="关闭"></a></div></div>';
				return t
			},
			...
			et.loginButtons = function () {
				var e = '<div class="ds-login-buttons"><p>Social account login:</p><div class="ds-social-links"><ul class="ds-service-list">' + et.serviceList(X) + '<li><a class="ds-more-services" href="javascript:void(0)">更多»</a></li></ul><ul class="ds-service-list ds-additional-services">' + et.serviceList(K) + "</ul></div></div>";
				return e
			},
			...
			et.meta = function (e) {
				...
				t += e.user_vote > 0 ? "Liked" : "Like",
				t += '</span><span class="ds-thread-cancel-like">Unlike</span></a><span class="ds-like-panel"></span></div>'
			},
			et.notify = function (e) {
				...
				t += '><a data-type="unread-comments" href="javascript:void(0);">你有' + e.comments + "条新Reply</a></li><li",
				...
				if (t += '<li class="ds-post" data-post-id="' + s.post_id + '"><div class="ds-post-self" data-post-id="' + s.post_id + '" data-thread-id="' + s.thread_id + '" data-root-id="' + s.root_id + '" data-source="' + s.source + '"><div class="ds-avatar"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ">" + et.avatar(r), S.sourceName[s.source] && (t += et.serviceIcon(s.source)), t += '</div><div class="ds-comment-body"><div class="ds-comment-header">', r.url ? (t += '<a class="ds-user-name ds-highlight" data-qqt-account="' + (r.qqt_account || "") + '" href="' + u(r.url) + '" ', r.user_id && (t += " onclick=\"this.href='" + a() + "/user-url/?user_id=" + r.user_id + "';\""), t += ' rel="nofollow" target="_blank"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ">" + u(r.name) + "</a>") : (t += '<span class="ds-user-name"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ' data-qqt-account="' + (r.qqt_account || "") + '">' + u(r.name) + "</span>"), t += "</div>", 1 == i.max_depth && i.show_context && s.parents.length) {
					...
					if (n)
						for (var o, d = -1, l = n.length - 1; l > d; )
							o = n[d += 1], 1 == d && s.parents.length > 2 && (t += '<li class="ds-ctx-entry"><a href="javascript:void(0);" class="ds-expand">还有' + (s.parents.length - 2) + "条Comment</a></li>"), t += et.ctxPost({
								post : o,
								index : d,
			...
			et.recentVisitors = function (e) {
				...
				if (s)
					for (var a, i = -1, r = s.length - 1; r > i; )
						a = s[i += 1], t += '<div class="ds-avatar">' + et.avatar(a, e.options.avatar_size) + "</div>";
				return t
			},
					...
					if (s)
						for (var a, i = -1, r = s.length - 1; r > i; ) {
							if (a = s[i += 1], t += ' <a href="' + a.url + '" class="ds-reads-item"> ', 3 == a.imgs.length) {
								...
								if (n)
									for (var o, d = -1, l = n.length - 1; l > d; )
										o = n[d += 1], t += ' <li> <div class="ds-reads-dumb"></div> <div class="ds-reads-pic-wrap" style="background-image:url(' + o + ');"></div> </li> ';
								...
								t += ' <div class="ds-reads-desc ', a.imgs.length || (t += "ds-reads-only"), t += '"> <div class="ds-reads-title">' + a.title + '</div> <div class="ds-reads-info"> ', 1 == a.type && (t += ' <span class="ds-reads-app-special">打开头条阅读</span> '), t += ' <span class="ds-reads-date" data-date="' + a.timeStamp + '"></span> </div> </div> ', a.imgs.length && (t += ' <div class="ds-reads-pic-right"> <div class="ds-reads-dumb"></div> <div class="ds-reads-pic-wrap" style="background-image:url(' + a.imgs[0] + ');"> ', a.hasVideo && (t += ' <div class="ds-reads-vid-info"><span>' + a.videoDuration + "</span></div> "), t += " </div> </div> "), t += " ";
							t += " </a> "
						}
					t += "</section></article>"
				}
			...
			et.serviceBindList = function (e) {
				...
				if (s)
					for (var a, i = -1, r = s.length - 1; r > i; )
						a = s[i += 1], t += '<li><a href="' + Z.bindUrl(a) + '" rel="nofollow" class="ds-service-link ds-' + a + '">' + S.serviceNames[a], nt.data.social_uid[a] && (t += ' <span class="ds-icon ds-icon-ok"></span>'), t += "</a></li>";
				return t
			},
			et.serviceList = function (e) {
				...
				if (s)
					for (var a, i = -1, r = s.length - 1; r > i; )
						a = s[i += 1], t += '<li><a href="' + Z.loginUrl(a) + '" rel="nofollow" class="ds-service-link ds-' + a + '">' + S.serviceNames[a] + "</a></li>";
				return t
			},
			et.shareWidget = function (e) {
				...
				if (s)
					for (var a, i = -1, r = s.length - 1; r > i; )
						a = s[i += 1], t += ' <li> <a class="ds-' + a + '" href="javascript:void(0);" data-service="' + a + '">' + S.sourceName[a] + "</a> </li> ";
			...
			et.toolbar = function () {
				var e = '<div class="ds-toolbar"><div class="ds-account-control"><span class="ds-icon ds-icon-settings"></span> <span>Account</span><ul><li><a class="ds-bind-more" href="javascript:void(0);" style="border-top: none">Binding</a></li><li><a target="_blank" href="' + S.REMOTE + "/settings/" + x(T()) + '">' + u(z.settings) + '</a></li><li><a rel="nofollow" href="' + Z.logoutUrl() + '" style="border-bottom: none">Logout</a></li></ul></div><div class="ds-visitor">';
				...
				e += '<a class="ds-unread-comments-count" href="javascript:void(0);" title="新Reply"></a></div></div>'
			},
			et.topThreads = function (e) {
				...
				if (s)
					for (var a, i = -1, r = s.length - 1; r > i; )
						a = s[i += 1], t += '<li><a target="_blank" href="' + u(a.url) + '" title="' + u(a.title) + '">' + u(a.title) + "</a></li>";
				return t
			},
			et.topUsers = function (e) {
				...
				if (s)
					for (var a, i = -1, r = s.length - 1; r > i; )
						a = s[i += 1], t += '<div class="ds-avatar">' + et.avatar(a, e.options.avatar_size) + "<h4>" + u(a.name) + "</h4></div>";
				return t
			},
			et.userInfo = function (e) {
				...
				return t += '<p class="ds-user-card-meta"><a href="' + S.REMOTE + "/profile/" + e.user_id + '/" target="_blank"><span class="ds-highlight">' + e.comments + "</span>Comments</a></p>",
			...
			S.require("embed.compat", function () {
				...
				function x(e, t, s, a) {
					function i() {
						...
						return a || l.find("[type=checkbox]:checked")[0] ? (R.post("posts/repost", S.toJSON(l), e), o.close(), !1) : (alert("还没有选Publish到哪儿呢"), !1)
					}
					function r() {
						var e = this.value;
				...
				function T(e) {
					var t = {
						"unread-comments" : {
							...
							tmpl : function (e) {
								return e.thread ? '<li data-thread-id="' + e.thread.thread_id + '">' + H.map(e.authors, et.userAnchor).join("、") + ' 在 <a class="ds-read" href="' + e.thread.url + '#comments" target="_blank">' + _(e.thread.title || "无标题") + '</a> 中Reply了你 <a class="ds-delete ds-read" title="知道了" href="javascript:void(0)">知道了</a></li>' : ""
							},
							read : function (e) {
				...
				function U(e, t) {
					...
					function i() {
						if (!confirm("确定要Delete这条Comment吗？"))
							return !1;
					...
					function n() {
						if (!confirm("确定要Report这条Comment吗？"))
							return !1;
						var e = H(this).closest(".ds-post-self");
				...
				st.Replybox.prototype = {
					render : function (e) {
						...
						for (var v in nt.data.repostOptions)
							nt.data.repostOptions[v] && (h.repostArray.push(v), h.checked = 1);
						...
						x = (g.find(".ds-add-image").click(function (e) {
								...
								if (t.selection) {
									...
									s.value = s.value.replace("Say something ...", ""),
									s.focus();
						...
						var q = function (e) {
							...
							R.post("posts/create", H.extend(S.toJSON(b), e), function (e) {
								...
								s = M(i.postList, t, c);
								if ("asc" == c.order == ("top" == c.formPosition) && S.scrollTo(s), o.data.comments++, o.updateCounter("duoshuo"), k.val("").trigger("keyup"), a(b), g.hasClass("ds-inline-replybox") && (g.detach(), i.actionsBar.removeClass("ds-reply-active")), m)
									try {
					...
					render : function () {
						function a(a) {
							...
							if (R.post("threads/vote", {
									...
									vote : p ? 0 : 1
								}, r), l.toggleClass("ds-thread-liked"), l.find(".ds-thread-like-text").text(p ? "Like" : "Liked"), p)
								return n.tooltip && c(a), !1;
							if (n.tooltip === s) {
				...
				st.Paginator.prototype = {
					reset : function (e) {
						...
						var s,
						a = this.collection.params.page || 1,
						i = [];
						if (a > 1)
				...
				st.EmbedThread = Q.extend({
						...
						render : function () {
							...
							if ("请将此处替换成文章在你的站点中的ID" === e.data("thread-key"))
								return alert("请Settings正确的 data-thread-key 属性"), !1;
						...
						updateCounter : function (e) {
							...
							var s = {
								duoshuo : ["comments", t(z.comments_multiple) || "Comment"],
								repost : ["reposts", t(z.reposts_multiple) || "Forward"],
						...
						onError : function (e) {
							this.el.html("Comment Error(" + e.code + "): " + e.errorMessage)
						},
						onload : function (t) {
							var a = this,
							...
							ot.on("reset", function () {
								...
								d.find("a.ds-unread-comments-count").html(e).attr("title", e ? "You already had " + e + "Replys" : "You don't have Reply").css("display", e ? "inline" : "none")
							}),
				...
				st.ShareWidget = Q.extend({
						...
						delegateEvents : function () {
							...
							i.delegate("a", "click", function (t) {
								...
								if (!i.data("url"))
									return void alert("Please set data-url");
								if ("wechat" === s) {
